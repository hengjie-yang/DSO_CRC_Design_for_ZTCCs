...
%               inputs
%       3) test_polynomial: the polynomial to be tested
...
polynomial=dec2bin(base2dec(test_polynomial, 8))-'0'; %convert to binary
polynomial=fliplr(polynomial); %degree from lowest to highest
